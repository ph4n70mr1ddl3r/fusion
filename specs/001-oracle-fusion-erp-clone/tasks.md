...
- [ ] T143b [P] [US8] Add scope-based data filtering to budget service repository queries (apply scoping to budget queries using `created_by_user_id` and `department_id` columns added in T223) in `services/budget/src/repository/`
- [ ] T143c [P] [US8] Add scope-based data filtering to tax service repository queries (apply scoping to tax transaction queries using `created_by_user_id` and `department_id` columns added in T263) in `services/tax/src/repository/`
- [ ] T143d [P] [US8] Add scope-based data filtering to asset service repository queries (apply scoping to fixed asset queries using `created_by_user_id` and `department_id` columns added in T283) in `services/asset/src/repository/`
